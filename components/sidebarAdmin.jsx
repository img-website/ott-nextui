                ...
                <div className="w-full bg-white dark:bg-zinc-800 lg:rounded-3xl shadow-lg h-full overflow-hidden p-5 flex flex-col">
                    ...
                    <div className="flex flex-col py-8 overflow-hidden -mr-5 grow">
                        <div className='flex flex-col overflow-auto h-full pr-5'>
                            {
                                sideLinks?.map(link => (
                                    <Link href={link?.href} key={link?.href} className={`flex items-center sm:gap-3 gap-2 py-3 px-4 rounded-lg text-zinc-300 md:hover:text-white md:hover:bg-zinc-900 duration-300 font-medium ${pathname == link.href ? '!text-white !bg-primary' : ''}`}>
