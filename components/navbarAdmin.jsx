...
import { HeartFilledIcon, MenuIcon, NotificationBellIcon, SearchIcon } from "./icons"
...
const NavbarAdmin = () => {
    return (
        <div className="flex items-center justify-between py-4 lg:py-8 container mx-auto max-w-7xl px-6">
            <Link href={'/admin/dashboard'} title='Logoipsum' className="w-full *:text-primary-500 dark:*:text-white md:*:w-48 *:w-36 *:aspect-[344/62] lg:hidden">
            ...
            <div className="w-auto">
                <div className="flex gap-4 items-center">
                    {/* <Button as={Link} href="/favorite" className="max-lg:hidden" isIconOnly color="danger" aria-label="Favorite">
                        <HeartFilledIcon className="text-xl" />
                    </Button> */}
                    ...
                    <Badge content="5" color="danger">
                        <Button as={Link} href="/admin/notification" isIconOnly color="warning" className="!bg-transparent" variant="bordered" aria-label="Notification">
                    ...
                    <Dropdown placement="bottom-start">
                        ...
                        <DropdownMenu
                            ...
                            closeOnSelect={false}
                        >
                            <DropdownItem key="profileDetail" className="h-14 gap-2">
                                <p className="font-bold">Signed in as</p>
                                <p className="font-bold">@tonyreichert</p>
                            </DropdownItem>
                            <DropdownItem key="Profile">
                                <Link className="w-full block" href="/admin/profile">Profile</Link>
                            </DropdownItem>
