"use client"
import { GlassesIcon, LockOpenIcon, LoginCircleIcon, OutlineMailIcon } from "@/components/icons";
...
const AdminSignin = () => {
    ...
    return (
        <Card as={"form"} className="w-96 dark:bg-gray-800 dark:text-white mx-auto has-[[aria-label=Loading]]:!pointer-events-none [&_label]:has-[[aria-label=Loading]]:!pointer-events-none">
